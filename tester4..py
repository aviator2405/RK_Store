...
class AmazonClone(tk.Tk):
    ...
    def create_widgets(self):
        ...
        wellabel = Label(self.product_frame, text=f'Welcome {self.username}', font='algerian 20 bold')
        wellabel.pack()
    ...
    def viewcart(self):
        ...
        if not self.cart:
            ...
            # address_label.pack()
            # address_entry = Entry(self.review_frame)
            # address_entry.pack()
            #
            # phone_label = Label(self.review_frame, text="Phone Number:")
            # phone_label.pack()
            # phone_entry = Entry(self.review_frame)
            # phone_entry.pack()
