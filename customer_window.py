...
class AmazonClone(tk.Tk):
    ...
    def create_widgets(self):
        ...
        self.product_frame.pack(padx=20, fill=tk.BOTH, expand=True)
        self.footer = tk.Frame(self, background='#363062')
        self.footer.pack(side="bottom", fill=tk.X)
        wellabel = Label(self.product_frame, text=f'WELCOME {str(self.user_data.iloc[0].username).upper()}',font='Centaur 20 bold',
                          fg='#F5E8C7',
                          background='#363062')
        wellabel.pack(fill=tk.X)

        product_label = tk.Label(self.footer, text="Products", font="algerian 22 italic", fg='#F5E8C7',background='#363062')
        product_label.pack(fill=tk.X,pady=30,padx=50 ,side=tk.RIGHT)
        ...
        add_to_cart_button = tk.Button(self.footer, text="Add to Cart", command=self.add_to_cart)
        add_to_cart_button.pack()

        checkout_button = tk.Button(self.footer, text="Checkout", command=self.show_review_page)
    ...
    def show_review_page(self):
        ...
        if not self.cart:
            ...
            checkout_button.pack(side=tk.LEFT,padx=70)
            ...
            back_button.pack(side=tk.LEFT,padx=70)
